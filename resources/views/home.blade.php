...
<section class="service">
    <div class="container d-flex flex-column">
        <a href="/web" class="service-block d-flex justify-content-between">
        ...
        <a href="/in_marketing" class="service-block d-flex justify-content-between">
        ...
        <a href="/integration_bots" class="service-block d-flex justify-content-between">
        ...
        <a href="/corp_systems" class="service-block d-flex justify-content-between">
        ...
        <a href="/branding" class="service-block d-flex justify-content-between">
        ...
        <a href="/design" class="service-block d-flex justify-content-between">
        ...
        <a href="/support" class="service-block d-flex justify-content-between">
        ...
        <a href="/mobile" class="service-block d-flex justify-content-between">
        ...
        <a href="/production" class="service-block d-flex justify-content-between">
        ...
        <a href="/analytics" class="service-block d-flex justify-content-between">
