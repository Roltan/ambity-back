            ...
            <div class="d-grid services-grid">
                ...
                <a href="/services/in-marketing" class="services-el">
                    ...
                    <p class="services-el-desc">
                        ...
                        подбираем каналы продвижения бренда исходя из целей и
                        задач. Анализируем результат на каждом этапе воронки.
                    </p>
                    <p class="services-el-props">
                ...
                <a href="/services/integration-bots" class="services-el">
                    ...
                    <p class="services-el-props">
                        Интернет-эквайринг, Чат-боты, Веб-сервисы, Синхронизация
                        с сервисами, Интеграция с CRM-системами, API, IIKO,
                        FrontPad, 1C
                    </p>
                </a>
                <a href="/services/corp-systems" class="services-el">
                    ...
                    <p class="services-el-desc">
                        Проводим анализ бизнес-процессов и оптимизируем.
                        Повышаем эффективность. Сокращаем затраты всех ресурсов
                        компании через автоматизацию бизнес-процессов и
                        внедрение CRM, ERP и BI-систем.
                    </p>
                    <p class="services-el-props">
                        Внедрение CRM, ERP и BI-систем, Настройка IP-телефонии,
                        Корпоративные порталы Битрикс24, AmoCRM, PlanIN
                    </p>
                </a>
                ...
                <a href="/services/design" class="services-el">
                    ...
                    <p class="services-el-desc">
                        Упрощаем восприятие технически сложных проектов через
                        эмоции и эстетику. Выстаиваем единую дизайн-систему для
                        лучшего восприятия бренда
                    </p>
                    <p class="services-el-props">
                ...
                <a href="/services/support" class="services-el">
                    ...
                    <p class="services-el-props">
                        Техническая поддержка, Актуализация контента, Контентная
                        поддержка, Обеспечение безопасности и работоспособности
                        проекта, Оптимизация производительности
                    </p>
                </a>
                <a href="/services/mobile" class="services-el">
                    ...
                    <p class="services-el-desc">
                        Разрабатываем нативные и удобные мобильные приложения
                        для решения конкретных бизнес-задач любой сложности,
                        используя современные технологии с интеграцией с любыми
                        системами.
                    </p>
                    <p class="services-el-props">
                ...
                <a href="/services/production" class="services-el">
                    ...
                    <p class="services-el-props">
                        Фото-продакшн, Видео-продакшн, 3D-визуализация,
                        Анимация, Фильмы
                    </p>
                </a>
                <a href="/services/analytics" class="services-el">
                    ...
                    <p class="services-el-desc">
                        ...
                        продвижения. Проверяем гипотезы на фокус-группах.
                        Переводим в цифры все процессы компании и анализируем
                        их.
                    </p>
                    <p class="services-el-props">
                        Предпроектный анализ, Юзабилити-аудит, SEO-аудит, Аудит
                        рекламных кампаний, Коллтрекинг и сквозная аналитика,
                        Анализ бизнес-процессов, Разработка технической
                        документации, Сквозная аналитика
                    </p>
                </a>
            </div>
        </section>
