...
<head>
    ...
    <link rel="stylesheet" href="/css/mobail_style.css">
    ...
    <script type="text/javascript">
        (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date();k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}) (window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym"); ym(45367569, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true, trackHash:true });
    </script>
    <script defer>
        document.addEventListener('DOMContentLoaded', function(){
    
            function clientsMarquee() {
                if(document.querySelector('.slider .slider-marquee div')){
                    document.querySelector('.slider .slider-marquee-high div').style.setProperty('--target','-'+document.querySelector('.slider .slider-marquee div>div').offsetWidth+'px');
                    document.querySelector('.slider .slider-marquee-low div').style.setProperty('--target','-'+document.querySelector('.slider .slider-marquee div>div').offsetWidth+'px');
                }
            }
            clientsMarquee();
            ...
            if(!getCookie('cookies')){
                ...
                document.querySelector('.cookie').classList.add('d-flex');
                document.querySelector('.cookie button').addEventListener('click', function (e){
                    e.preventDefault();
                    document.querySelector('.cookie').classList.remove('d-flex');
            ...
            document.querySelector(".btn-close-sidenav").addEventListener("click",function (){
                this.classList.toggle("active");
                document.querySelector(".sidenav").classList.toggle("active");
                document.querySelector(".sidenav-trigger").classList.toggle("active");
                if(this.classList.contains('active')){
                    document.querySelector('body').style.overflow='hidden';
                }else{
                    document.querySelector('body').style.overflow='';
...
<body>
    ...
    <header class="">
        <div class="d-flex align-items-center justify-content-between container h-100">
            ...
            <div class="header-links">
                <div class="sidenav-trigger" id="pressme"><div></div></div>
            </div>
        </div>
    </header>
    <div class="sidenav d-flex flex-column align-items-center active">
        <div class="sidenav__content d-flex align-items-center">
            <div class="sidenav__content__block display-flex">
        ...
        <div class="c-contacts-grid d-flex flex-column align-items-center">
            <div class="c-contact d-flex align-items-center">
                <a class="c-contact__item" href="tel:+79373301921"><span itemprop="telephone">+7 (937) 330-19-21</span></a>
            </div>
            <div class="c-contact d-flex align-items-center">
                <a class="c-contact__item" href="mailto:{{$contact->email}}"><span itemprop="email">{{$contact->email}}</span></a>
            </div>
            <div class="c-contact d-flex align-items-center justify-content-center" itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress">
                <button class="btn-white btn-close-sidenav" onclick="document.querySelector('.modal').style.top='0';">Обсудить проект</button>
            </div>
            <div class="c-contact d-flex align-items-center justify-content-end">
                <div class="c-contact__item">
                    <div class="soc_icons d-flex">
                        <a target="_blank" href="http://vk.com/ambity">
    ...
    <div class="modal flex-column align-items-center" style="top: 110%;">
        <div class="modal-head container d-flex justify-content-between align-items-center" style="position: absolute;">
            <a href="/">
                <img src="https://ambity.ru/media/logo.svg">
            </a>
            <!--<div class="modal-close" onclick="document.querySelector('.modal').style.display='none';"></div>-->
            <div class="modal-close" onclick="document.querySelector('.modal').style.top='110%'; document.querySelector('body').style.overflow='unset'; document.querySelector('.modal-head').style.position='absolute';"></div>
        </div>
        <div class="container width95">
            <div class="modal-con d-flex flex-column justify-content-between">
                <div>
                ...
                <form>
                    ...
                    <textarea class="c-form__input" placeholder="Детали проекта"></textarea>
                    <div class="policy d-flex flex-column align-items-center">
                        ...
                        <button class="c-form__button btn-white text-nowrap">Обсудить проект</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <footer>
        <div class="footer container d-flex flex-column">
            <div class="footer-desc d-flex flex-column align-items-start">
                ...
                <button class="btn-white" onclick="document.querySelector('.modal').style.top='0'; document.querySelector('body').style.overflow='hidden'; document.querySelector('.modal-head').style.position='fixed';">Обсудить проект</button>
            </div>
            <div class="footer-cont d-flex flex-column">
                <a class="footer-cont-href d-flex txt-anim" href="tel:{{$contact->phone}}"><p>{{$contact->phone}}</p><span>{{$contact->phone}}</span></a>
        ...
        <div class="last-footer container d-flex flex-column">
            <p>ИП Нигматуллин А.З.</p>
            <p>ОГРНИП 315028000132311</p>
            <a href="/policy">Политика конфеденциальности</a>
        </div>
    </footer>
    <div class="cookie d-none justify-content-between align-items-center">
