...
@section('mainContent')
<section class="web-title d-flex flex-column align-items-center justify-content-center container headFollow">
    <div class="appearance_bottom headFollow-item val-10">
        <h1 class="headText">WEB-разработка</h1>
    </div>
    <div class="text">
        <div class="appearance_bottom">
            <p class="text-center">Создаем удобные и эффективные интернет-проекты<br>
                для решения конкретных бизнес-задач любой<br>
                сложности, используя современные технологии</p>
        </div>
    </div>
</section>
<section class="services container">
    <div class="d-grid services-grid">
        <a href="/corpsite" class="services-el appScroll_bottom">
...
<section class="process container">
    <div class="d-flex flex-row process-flex">
        <div class="process-el-fix">
            <h2 class="process-el-fix-text">Процесс</h2>
            <p>Системный подход в решении задач позволяет гибко планировать проект и не отклоняться от оговоренных сроков</p>
        </div>
        <div class="d-grid process-el-scroll">
            <div class="process-el-scroll-cont">
                <h3 class="process-el-scroll-cont-text">Брифинг, проведение воркшопа</h3>
                <span class="text-span">Встреча команд агентства и клиента. Определяем формат работы и коммуникации команд. Определяем пожелания и погружаемся в проект</span>
            </div>
            <div class="process-el-scroll-cont">
                <h3 class="process-el-scroll-cont-text">Исследование, аналитика и проектирование</h3>
                <span class="text-span">Встреча команд агентства и клиента. Определяем формат работы и коммуникации команд. Определяем пожелания и погружаемся в проект</span>
            </div>
            <div class="process-el-scroll-cont">
                <h3 class="process-el-scroll-cont-text">Тестирование гипотез на прототипах</h3>
                <span class="text-span">Встреча команд агентства и клиента. Определяем формат работы и коммуникации команд. Определяем пожелания и погружаемся в проект</span>
            </div>
            <div class="process-el-scroll-cont">
                <h3 class="process-el-scroll-cont-text">Разработка дизайн-концепции</h3>
                <span class="text-span">Встреча команд агентства и клиента. Определяем формат работы и коммуникации команд. Определяем пожелания и погружаемся в проект</span>
            </div>
            <div class="process-el-scroll-cont">
                <h3 class="process-el-scroll-cont-text">Дизайн внутренних страниц и создание контента</h3>
                <span class="text-span">Встреча команд агентства и клиента. Определяем формат работы и коммуникации команд. Определяем пожелания и погружаемся в проект</span>
            </div>
            <div class="process-el-scroll-cont">
                <h3 class="process-el-scroll-cont-text">Frontend-разработка</h3>
                <span class="text-span">Встреча команд агентства и клиента. Определяем формат работы и коммуникации команд. Определяем пожелания и погружаемся в проект</span>
            </div>
            <div class="process-el-scroll-cont">
                <h3 class="process-el-scroll-cont-text">Backend-разработка</h3>
                <span class="text-span">Встреча команд агентства и клиента. Определяем формат работы и коммуникации команд. Определяем пожелания и погружаемся в проект</span>
            </div>
            <div class="process-el-scroll-cont">
                <h3 class="process-el-scroll-cont-text">Тестирование и отладка. Наполнение.</h3>
                <span class="text-span">Встреча команд агентства и клиента. Определяем формат работы и коммуникации команд. Определяем пожелания и погружаемся в проект</span>
            </div>
            <div class="process-el-scroll-cont">
                <h3 class="process-el-scroll-cont-text">Запуск MVP</h3>
                <span class="text-span">Встреча команд агентства и клиента. Определяем формат работы и коммуникации команд. Определяем пожелания и погружаемся в проект</span>
            </div>
        </div>
    </div>
